...
requestAnimationFrame(AC_GAME_ANIMAATION);class ChatField {
...
class MultiPlayerSocket{
    constructor(playground) {
        this.playground=playground
        this.ws=new WebSocket("wss://app3114.acapp.acwing.com.cn/wss/multiplayer/")
        this.start()
    }
    start() {
        this.receive();
    ...
    get_random_color(){
        let colors=['blue','pink','red','green','grey']
